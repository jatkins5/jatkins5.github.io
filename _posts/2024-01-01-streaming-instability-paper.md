---
layout: post
title: "New Publication: Streaming Instability in Protolunar Disks"
date: 2024-06-01
---

<div class="publication-header clickable" onclick="window.open('/assets/pdf/Nakajima_2024_Planet._Sci._J._5_145.pdf', '_blank')">
  <img src="/assets/img/nakajima2024-icon.png" alt="Moon formation simulation" class="publication-image">
  <div class="publication-info">
    <p><em>The Limited Role of the Streaming Instability in Protolunar Disks</em></p>
    <p><em>Miki Nakajima, Jeremy L. Atkins, Jacob B. Simon, Alice C. Quillen</em><br>
    <em>The Planetary Science Journal, Volume 5, Number 6 (2024)</em></p>
  </div>
</div>
